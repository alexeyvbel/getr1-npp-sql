...
FROM (SELECT a.abonent_id, a.bst_type, a.bst_nr, b.kanal, a.count, a.bus_addr, a.sbst_type, a.sbst_nr
      FROM (SELECT a.abonent_id, a.bst_type, a.bst_nr, a.bus_addr, a.sbst_type, a.sbst_nr,
                   CASE WHEN a.bst_type = 'MKE' THEN (32 - count(bst_nr)) WHEN a.bst_type = 'A%E'  THEN (28 - count(bst_nr)) END as count
            FROM (
                     SELECT DISTINCT a.*, b.bus_addr as bus_addr, b.sbst_type as sbst_type, b.sbst_nr as sbst_nr
                     FROM (
                              ...
                              UNION SELECT abonent_id, left(telegram,3) as bst_type, right(telegram,length(telegram)-3)::integer as bst_nr, kanal FROM laes_2_blok_1_echsr_k_12008591657336291get.Pageleft WHERE telegram IS NOT NULL AND telegram NOT LIKE 'BST%') AS a
                              LEFT JOIN (
                         ...
                         FROM (SELECT abonent_id, bus_addr::integer, sbst_nr, sbst_type, bst_type, bst_nr FROM f7952415767822940get.bst
                             ...
                             UNION SELECT abonent_id, left(telegram,3) as bst_type, right(telegram,length(telegram)-3)::integer as bst_nr, kanal FROM laes_2_blok_1_echsr_k_12008591657336291get.Pageright WHERE telegram IS NOT NULL AND telegram NOT LIKE 'BST%') AS b
                                             ON a.bus_addr = b.abonent_id and a.sbst_type = b.bst_type and a.sbst_nr = b.bst_nr
                     ) as b
          ...
          FROM  (SELECT DISTINCT a.abonent_id, a.bst_type, a.bst_nr, b.kanal FROM (
                                                                                      ...
                                                                                      RIGHT JOIN (SELECT generate_series as kanal FROM generate_series(1,32)) as b ON a.kanal<>b.kanal WHERE a.bst_type = 'MKE') as b
                    LEFT JOIN (
              SELECT DISTINCT a.*
              FROM (
                       SELECT abonent_id, left(telegram,3) as bst_type, right(telegram,length(telegram)-3)::integer as bst_nr, kanal FROM f7952415767822940get.Pageleft WHERE telegram IS NOT NULL AND telegram NOT LIKE 'BST%'
          ...
          WHERE c.kanal is null AND b.bst_type = 'MKE'
          UNION
          SELECT b.abonent_id, b.bst_type, b.bst_nr, b.kanal
          FROM  (SELECT DISTINCT a.abonent_id, a.bst_type, a.bst_nr, b.kanal FROM (
                                                                                      SELECT DISTINCT a.*
                                                                                      ...
                                                                                      RIGHT JOIN (SELECT generate_series as kanal FROM generate_series(1,28)) as b ON a.kanal<>b.kanal WHERE a.bst_type = 'AKE') as b
                    LEFT JOIN (
              SELECT DISTINCT a.*
              FROM (
                       SELECT abonent_id, left(telegram,3) as bst_type, right(telegram,length(telegram)-3)::integer as bst_nr, kanal FROM f7952415767822940get.Pageleft WHERE telegram IS NOT NULL AND telegram NOT LIKE 'BST%'
          ...
          WHERE c.kanal is null AND (b.bst_type = 'A%E')) as b
                         ON a.abonent_id = b.abonent_id AND a.bst_type = b.bst_type AND a.bst_nr = b.bst_nr
      ORDER BY a.abonent_id, a.bst_type, a.bst_nr, b.kanal
     ) AS a
WHERE a.abonent_id = 536 AND a.bst_type = 'ATE' AND a.bst_nr is not null;
